...
Currently the roadmap that is going to be supported is:
- starting vm's in libvirt
- checking if the platform supports libvirt
- destroying vm's
- and more quality of life commands, such as networking and ssh
